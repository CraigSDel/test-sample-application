...
class TestSampleApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        TestSampleApplicationKafkaResource kafkaResource = new TestSampleApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/test-sample-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/test-sample-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
