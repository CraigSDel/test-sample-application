...
@RestController
@RequestMapping("/api/test-sample-application-kafka")
public class TestSampleApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TestSampleApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TestSampleApplicationKafkaResource(KafkaProperties kafkaProperties) {
